...
module.exports = function(webpackEnv) {
  ...
  // path. In development, we always serve from the root. This makes config
  // easier.
  const publicPath =
  ...
  const publicUrl =
      isEnvProduction ? publicPath.slice(0, -1) : isEnvDevelopment && '';
  ...
  return {
    ...
    entry : [
      ...
      // changes. When you save a file, the client will either apply hot updates
      // (in case of CSS changes), or refresh the page (in case of JS changes).
      // When you make a syntax error, this client will display a syntax error
      // overlay. Note: instead of the default WebpackDevServer client, we use a
      // custom one to bring better experience for Create React App users. You
      // can replace the line below with these two lines if you prefer the stock
      // client: require.resolve('webpack-dev-server/client') + '?/',
    ...
    plugins : [
      ...
      // have
      // to restart the development server for Webpack to discover it. This
      // plugin
      ...
      useTypeScript && new ForkTsCheckerWebpackPlugin({
        ...
        resolveModuleNameModule : process.versions.pnp ? `${__dirname}/pnpTs.js`
                                                       : undefined,
        resolveTypeReferenceDirectiveModule :
            process.versions.pnp ? `${__dirname}/pnpTs.js` : undefined,
        ...
        watch : paths.appSrc,
        silent : true,
        // The formatter is invoked directly in WebpackDevServerUtils during
        // development
